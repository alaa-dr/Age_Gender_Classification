...
# shoeing my log message like loggings #TODO don't forget to remove this lol
logging.basicConfig(level=logging.logging)


def get_args():
    # formatter_class= argparse.ArgumentDefaultsHelpFormatter
    parser = argparse.ArgumentParser(description="This script trains the CNN model for age and gender .")
...
class Schedule:
    ...
    """ Logging for me :) i will not use __call__ because i am planing to use adam
     but remember that call is to change learning rate dependent on num of epochs
    """
...
def main():
    ...
    logging.debug("Alaa --> Loading data...")
    ...
    logging.debug("Alaa -->  my Model summary...")
    model.count_params()
    model.summary()
    ...
    logging.debug("Alaa -->  Running training...")
    ...
    logging.debug("Alaa -->  Saving history...")
